...
$('#calendar').fullCalendar({
	eventClick: function( event, jsEvent, view ) {
		fullCalendar( 'removeEvent', event.id);
		console.log("check");
	 }
});
...
function( event, jsEvent, view ) { 
	//set delete button to true so it will show
	.fullCalendar( 'removeEvent', id) //delete event
}

//when user mouses out of an event
function( event, jsEvent, view ) { 
	//set delete button to false so it will hide
} */
